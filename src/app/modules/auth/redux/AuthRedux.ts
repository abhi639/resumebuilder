...
export const reducer = persistReducer(
  {storage, key: 'v100-ResumBuilder-frontend-auth', whitelist: ['user', 'accessToken']},
...
export function* saga() {
  ...
  //   yield logout(); // Call the logout API function
  // });
  yield takeLatest(actionTypes.Logout, function* logoutSaga() {
    // Call the logout API
    try {
      // Assuming you have a `logout` API function
      yield logout()
    } catch (error) {
