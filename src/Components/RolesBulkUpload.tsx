...
const RolesBulkupload = () => {
  ...
  const uploadFile = async (file: File) => {
    ...
    try {
      const response = await axios.post('http://localhost:8082/upload/RoleExcel', formData, {
  ...
  const searchSettings: SearchSettingsModel = {
    fields: ['serialNumber', 'role_name', 'status', 'remark'],
  }
  ...
  return (
    <>
      <div style={gridContainerStyle}>
        <PageTitle>Bulk Upload | Roles</PageTitle>
...
export default RolesBulkupload
