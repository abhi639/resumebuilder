  ...
  return (
    ...
    >
      <div className='aside-logo flex-column-auto' id='kt_aside_logo' style={{ backgroundColor: 'white' }}>
        {aside.theme === 'dark' && (
          <Link to='/dashboard'>
            <img alt='Logo' className='h-80px logo' src={toAbsoluteUrl('/media/logos/logo2.png')} />
          </Link>
        )}
        {aside.theme === 'light' && (
          <Link to='/dashboard'>
      ...
      <div
        className={clsx('aside-menu flex-column-fluid', isAsideMinimized && 'aside-menu-minimized')}
      >
